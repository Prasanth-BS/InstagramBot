...
/*export default */async function getData(noOfElements) {
    ...
    for(let i = 1; i <= noOfElements; i ++){
        ...
        // const imageLinks__artStation = await page.$$eval('picture.d-block > img', async elements => {
        //     let j = 0;
        //     return elements.map(async ele => {
        //         const path = `../images/post${i}/img${j++}.png`
        //         return await downloadImage(ele.src, path)
        //     })
        // })
        ...
        artistData.push({title, artistName, tags, imageLinks__fs})
